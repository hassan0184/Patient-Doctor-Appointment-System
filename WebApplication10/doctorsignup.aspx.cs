...
namespace WebApplication10
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (sqlCon.State == System.Data.ConnectionState.Open)
            {
                ...
                else
                {
                    ...
                    p = "insert into doctor_basic(fullname,pmdcno,cnic,city,dateofbirth,gender,mobileno,email,address,age,pasword,confirmpasword,yourself,doctor_category,appointments_count,ProfileViews,MyReviews)values('" + fullname.Text + "','" + pmdcno.Text.ToString() + "','" + cnic.Text.ToString() + "','" + city.SelectedItem.Value + "','" + date.Text + "','" + gender.SelectedItem.Value + "','" + mobileno.Text + "','" + email.Text + "','" + address.Text + "','" + age.Text.ToString() + "','" + password.Text + "','" + confirmpassword.Text + "','" + yourself.Text + "','" + cateogory.SelectedItem.Value + "','" + 0 + "','" + 0 + "','" + 0 + "')";
        ...
        private Boolean checkemail()
        {
            ...
            String myquery = "Select * from doctor_basic where cnic='" + cnic.Text.ToString() + "'";
