<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doctor_appointment.aspx.cs" Inherits="WebApplication10.WebForm7" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Doctor_Appointments</title>
        ...
        <div class="container">
            <div class="row" style="margin-left:350px;margin-top:70px" >
                ...
                <div class="col-6 form-group">
                    <h1 class="text-center" style="color:#0e60a3;">Delete Appointment</h1>
