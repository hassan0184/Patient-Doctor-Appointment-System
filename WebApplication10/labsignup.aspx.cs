...
{
    public partial class labsignup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (sqlCon.State == System.Data.ConnectionState.Open)
            {
                ...
                else
                {
                    ...
                    p = "insert into lab_basic(fullname,fathername,cnic,city,dateofbirth,gender,mobileno,email,address,age,pasword,confirmpasword,yourself,MyReviews,appointment_with,appointment_count,lab_history)values('" + fullname.Text + "','" + fathername.Text.ToString() + "','" + cnic.Text.ToString() + "','" + city.SelectedItem.Value + "','" + date.Text + "','" + gender.SelectedItem.Value + "','" + mobileno.Text + "','" + email.Text.ToString() + "','" + address.Text + "','" + age.Text.ToString() + "','" + password.Text + "','" + confirmpassword.Text + "','" + yourself.Text + "','" + 0 + "','" + 0 + "','" + 0 + "','" + 0 + "')";
