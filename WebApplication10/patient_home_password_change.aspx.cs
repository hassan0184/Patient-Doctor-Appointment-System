...
{
    public partial class patient_home_password_change : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("select pasword,confirmpasword from patient_basic where cnic = '" + Session["cnic_from_login_page_patient"] + "' "))
                    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            sqlCon.Open();
            string s = "update patient_basic set pasword='" + password.Text + "',confirmpasword='" + confirmpassword.Text + "' from patient_basic where cnic = '" + Session["cnic_from_login_page_patient"] + "' ";
