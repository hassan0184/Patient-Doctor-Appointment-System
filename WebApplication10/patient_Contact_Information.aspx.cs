...
{
    public partial class patient_Contact_Information : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("select fullname,cnic,email,mobileno from patient_basic where cnic = '" + Session["cnic_from_login_page_patient"] + "' "))
                    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            sqlCon.Open();
            string s = "update patient_basic set fullname='" + fullname.Text + "',cnic='" + cnic.Text.ToString() + "',email='" + email.Text + "',mobileno='" + phoneno.Text + "' from doctor_basic where cnic = '" + Session["cnic_from_login_page_patient"] + "' ";
