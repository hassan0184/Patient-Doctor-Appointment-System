<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="labsignup.aspx.cs" Inherits="WebApplication10.labsignup" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Lab Attendent Signup</title>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title  font-weight-bolder" id="exampleModalLabel">Lab Attendent Signup Form</h3>
                ...
                *</span></label><asp:TextBox ID="fullname"  class="form-control form-control-solid" runat="server"></asp:TextBox>
                        ...
                        <div class="col-md-4">
                            <div class="form-group"><label for="fathername"> Father Name <span style="color: red;">
