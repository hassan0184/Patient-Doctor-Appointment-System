<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patient_password_change.aspx.cs" Inherits="WebApplication10.WebForm2" %>
...
<body>
    ...
    <form id="form1" runat="server" class="preloader">
        <div class="container" style="opacity:0.8;margin-top:100px">
            <div class="row">
                <div class="col">
                     <div id="exampleModal ">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title  font-weight-bolder" id="exampleModalLabel">Password Reset Form</h3>
