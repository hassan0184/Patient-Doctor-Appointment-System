<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doctor_Contact_Information.aspx.cs" Inherits="WebApplication10.WebForm6" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>Doctor_Contact_Information</title>
...
></asp:HyperLink>                    </li>
            ...
            <div class="col-9" style="margin-top:40px">
                <h3 class="font-weight-bolder text-center" style="color:#0e60a3;">
                    Contact Information
                </h3>
                <hr>
