<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patient_home_password_change.aspx.cs" Inherits="WebApplication10.patient_home_password_change" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Patient_Home_Change_Password</title>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title  font-weight-bolder" id="exampleModalLabel" style="color:#1d86de;">Password Reset Form</h3>
