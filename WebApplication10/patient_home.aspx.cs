    ...
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("select fullname,Myreviews as ReviewsOnMyProfile,appointments_count as PendingAppointmentsWithDoctor from patient_basic where cnic = '" + Session["cnic_from_login_page_patient"] + "' "))
                    {
                        ...
                        using (SqlDataReader sdr = cmd.ExecuteReader())
                        {
                            ...
                            reviews.Text = sdr["ReviewsOnMyProfile"].ToString();
